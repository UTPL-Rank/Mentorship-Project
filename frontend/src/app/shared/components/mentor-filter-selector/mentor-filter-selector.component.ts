...
export class MentorFilterSelectorComponent implements OnInit, OnDestroy {
  ...
  private selectedValueChanged: Subscription | null = null;
  private routeMentorIdChanged: Subscription | null = null;

  public readonly mentors$: Observable<Array<SGMMentor.readDTO>> = this.route.params.pipe(
