...
// import { AccompanimentsService, QueryAccompaniments } from '../../../core/services/accompaniments.service';
// import { MentorsService } from '../../../core/services/mentors.service';
// import { TitleService } from '../../../core/services/title.service';
// import { FirestoreAccompaniments, Mentor } from '../../../models/models';
...
//     private readonly accompanimentsService: AccompanimentsService,
//   ) {
//     this.accompanimentsObs.subscribe(console.log);
...
//   public readonly accompanimentsObs: Observable<FirestoreAccompaniments> = forkJoin({
...
//       const query: QueryAccompaniments = {
//         limit: 10,
//         ...params
//       };
...
//       return null;
//     }),
//     switchMap(q => this.accompanimentsService.accompanimentsStream(q))
//   );
